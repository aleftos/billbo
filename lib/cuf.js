 ...
 *        getCUFTime: Return current date in required format.
...
module.exports = {
  ...
  */
  cuf: (
    NIT_EMISOR,
    NÚMERO_FACTURA,
    FECHA_HORA = getBOTime(),       // default = getTime
  ...
  */
  getCUF: (data = {
    ...
    if (data.NIT_EMISOR === undefined) return 'ERROR';
    if (data.NÚMERO_FACTURA === undefined) return 'ERROR';
    if (data.FECHA_HORA === undefined) data.FECHA_HORA = getBOTime();
    if (data.SUCURSAL === undefined) data.SUCURSAL = '0';
    if (data.MODALIDAD === undefined) data.MODALIDAD = '1';
    if (data.TIPO_EMISIÓN === undefined) data.TIPO_EMISIÓN = '1';
    if (data.CÓDIGO_DOCUMENTO_FISCAL === undefined) data.CÓDIGO_DOCUMENTO_FISCAL = '1';
    if (data.TIPO_DOCUMENTO_SECTOR === undefined) data.TIPO_DOCUMENTO_SECTOR = '1';
